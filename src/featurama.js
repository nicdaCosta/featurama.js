...
window.featurama = ( function( window , document , undefined ) {
	...
	**/
	...
	/* Private Method extendObject
	** parameter { object } - object that will be extended
	** parameter { object } - object to be cloned.
	** parameter { boolean } - flag on whether to overwrite a property should it exist in the object to extend
	** about - used to extend one object with another's properties, aka clone. This is used when writing the tests to localStorage so not to modify the original test.
	**/
